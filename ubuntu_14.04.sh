...
sudo apt-get install -y build-essential python-numpy python-scipy cython python-nose git cmake vim emacs gfortran libblas-dev liblapack-dev libhdf5-dev gfortran liblapack-dev libblas-dev python-tables
